  ...
  return (
    <section className="intro">
      <p>
        ...
        and the code is as unpredictable as a cat’s mood. Most of this magic
        happens thanks to my <strong>infinite-questions buddy</strong> —
        <a className="ai-links" href="https://openai.com/chatgpt">
          ChatGPT
        </a>
        — who never says "<strong>that’s a silly question</strong>" and somehow
        always has an answer, even though I’m constantly tweaking, bossing
        around, and blaming it when things go sideways.
      </p>
      <p>
        Dive in, explore my projects, catch the socials (coming soon), and don’t
        forget to tell your cat I said
        <span
          id="cat-call"
